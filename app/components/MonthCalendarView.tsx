  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-zinc-900">Full Schedule</h2>
          <p className="text-zinc-500 text-sm mt-1">3 workers per day • 5 shifts per week • 40 hours per week</p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-lg font-semibold text-zinc-900 min-w-[180px] text-center">
              {monthName}
            </div>
            <button 
              onClick={nextMonth}
        ...
        <div className="grid grid-cols-7">
          {dates.map((date, index) => {
            ...
            return (
              <div 
                key={date} 
                className={`min-h-[120px] border-b border-r border-zinc-100 p-2 hover:bg-zinc-50/50 transition-colors ${
